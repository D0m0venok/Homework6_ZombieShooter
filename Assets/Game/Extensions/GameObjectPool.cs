...
namespace Extensions
{
    public abstract class GameObjectsPool<T> where T : Component
    {
        ...
        protected GameObjectsPool(DiContainer diContainer, T prefab, Transform activeContainer = null, Transform disableContainer = null, int initSize = 0, int maxSize = int.MaxValue)
        {
            if (prefab == null)
